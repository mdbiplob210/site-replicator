// Service Worker v5 — maximum speed caching
const STATIC_CACHE = 'static-v5';
const API_CACHE = 'api-v5';
const IMG_CACHE = 'img-v5';
const NAV_CACHE = 'nav-v5';
...
self.addEventListener('fetch', (event) => {
  ...
  // Images (Supabase storage) → cache-first with background revalidate
  ...
  // External images (CDN, Facebook, etc) → cache-first
  ...
  // API → stale-while-revalidate (instant from cache, update background)
