...
const faqs = [
  {
    q: "SOHOZ PRO কি ফ্রি ব্যবহার করা যায়?",
    a: "হ্যাঁ! SOHOZ PRO-তে একটি ফ্রি প্ল্যান আছে যেখানে আপনি বেসিক ফিচারগুলো ব্যবহার করতে পারবেন। অ্যাডভান্সড ফিচারের জন্য পেইড প্ল্যান আপগ্রেড করতে পারবেন।",
  },
  {
