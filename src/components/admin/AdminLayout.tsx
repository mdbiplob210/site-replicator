      ...
      <div className="min-h-screen flex w-full bg-background">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <header className="h-14 flex items-center border-b border-border/40 px-4 gap-3 bg-card/90 glass sticky top-0 z-10">
            ...
            {/* Search */}
            <div className="hidden md:flex items-center gap-2.5 bg-secondary/70 rounded-xl px-4 py-2 border border-border/50 hover:border-primary/40 hover:shadow-sm transition-all cursor-pointer group">
