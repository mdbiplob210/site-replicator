      ...
      <Card className="w-full max-w-md border-border/60 shadow-xl">
        <CardContent className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-primary text-lg hover:bg-primary/90">
              সাইন ইন
            </Button>
          </form>
          ...
          <Button variant="outline" className="w-full gap-2" onClick={() => console.log("Google login")}>
